...
/**
 * Script file of miniorange_otp_system_plugin.
 *
 ...
 */
class plgSystemMiniorangeverifyotpInstallerScript
{
    /**
    ...
    public function install($parent) 
    {
          ...
          $query->where($db->quoteName('element') . ' = ' . $db->quote('miniorangesendotp'));
          ...
          $query1->where($db->quoteName('element') . ' = ' . $db->quote('miniorangeverifyotp'));
          ...
          $query2->where($db->quoteName('element') . ' = ' . $db->quote('miniorangeotpplugin'));
          $query2->where($db->quoteName('type') . ' = ' . $db->quote('library'));
          $db->setQuery($query2);
          $db->execute();
